...
static irqreturn_t dss_irq_handler_omap3(int irq, void *arg)
{
	...
	if(!(omap_readl(0x48004E10) && 0x1 ))
	{
		printk(KERN_ERR "DSS ICLK Not enabled yet\n");
		omap_writel(1,0x48004E10);
	}

	if(!(omap_readl(0x48004E00) && 0x1 ))
	{
		printk(KERN_ERR "DSS FCLK Not enabled yet\n");
		omap_writel(omap_readl(0x48004E00)|0x1,0x48004E00);
	}
