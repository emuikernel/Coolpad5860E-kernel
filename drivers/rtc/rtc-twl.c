...
extern bool rtc_wakeup_from_suspend;//yulong.huangjiefeng.2011-2-28
/*----------------------------------------------------------------------*/
...
//yulong.huangjiefeng.2011-2-28
	if(rtc_wakeup_from_suspend)
	{
		rtc_wakeup_from_suspend = 0;
...
//yulong.huangjiefeng.2011-2-28
	 ...
	 * by reading RTS_INTERRUPTS_REGISTER[IT_TIMER,IT_ALARM]
	 */
	if ((rd_reg & BIT_RTC_STATUS_REG_ALARM_M) == 0)
		rtc_wakeup_from_suspend = 0;
