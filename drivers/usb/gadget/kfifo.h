...
extern void kfifo_init_gadget(struct kfifo *fifo, void *buffer,
         unsigned int size);
extern __must_check int kfifo_alloc_gadget(struct kfifo *fifo, unsigned int size,
         gfp_t gfp_mask);
 extern void kfifo_free_gadget(struct kfifo *fifo);
