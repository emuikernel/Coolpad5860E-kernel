...
//	i = KEYP_PERIOD_US(20000, PTV_PRESCALER);
	i = KEYP_PERIOD_US(30000, PTV_PRESCALER);
...
//Added for supporting wakup system when press volum key by huangjiefeng in 20100816
...
static int twl4030_kp_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	{
		data = ~(KEYP_IMR1_KP | KEYP_IMR1_TO);
	}
	else
	{
		data = KEYP_IMR1_KP | KEYP_IMR1_TO;
	}
	twl_i2c_write_u8(TWL4030_MODULE_KEYPAD, data, KEYP_IMR1);
