...
#define OMAP_FT5X06_IRQ_GPIO_P0     115
#define OMAP_FT5X06_IRQ_GPIO_P1     143
#define OMAP_FT5X06_PWR_EN_GPIO     178
#define OMAP_FT5X06_RST_GPIO        16

#define OMAP_FT5X06_I2C_SCL_GPIO    168
#define OMAP_FT5X06_I2C_SDA_GPIO    183

#define TS_IRQ_GPIO_NAME_P0         "gpio_115"
#define TS_IRQ_GPIO_NAME_P1         "gpio_143"
#define TS_PWR_EN_GPIO_NAME         "gpio_178"
#define TS_RST_GPIO_NAME            "gpio_16"

#define TS_FT5X06_I2C_SCL_GPIO_NAME  "gpio_168"
#define TS_FT5X06_I2C_SDA_GPIO_NAME  "gpio_183"

#define FT5X0X_NAME	"ft5x0x_ts" //"ft5x0x_ts"//"synaptics_i2c_rmi"//"synaptics-rmi-ts"// 
