...
//extern int change_cpu_freq_in_touch;//yulong.huangjiefeng.2011-2-28
static void dbs_check_cpu(struct cpu_dbs_info_s *this_dbs_info)
{
	...
	for_each_cpu(j, policy->cpus) {
		...
		//if(change_cpu_freq_in_touch > 0)
		//{
			//load = 100;
			//change_cpu_freq_in_touch--;
		//}

		//added by huangjiefeng
		if(omap_clock_test == PRINT_CP_CPU_IDLE)
			printk(KERN_ERR"odm load=%d, wall_time=%d, idle_time=%d\n",load,wall_time,idle_time);
