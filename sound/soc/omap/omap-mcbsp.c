...
extern void omap_mcbsp_disable_fclk(unsigned int id);
extern void omap_mcbsp_enable_fclk(unsigned int id);
...
#if defined(CONFIG_ARCH_OMAP24XX) || defined(CONFIG_ARCH_OMAP3)
