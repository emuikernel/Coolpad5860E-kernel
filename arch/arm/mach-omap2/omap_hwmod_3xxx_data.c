...
static struct omap_hwmod omap3xxx_gpio1_hwmod = {
	...
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAP3430),
	.flags          = HWMOD_INIT_NO_RESET,//Added by huangjieng, dont need init gpio in bootup
};
...
static struct omap_hwmod omap3xxx_gpu_hwmod = {
	...
	.flags		= HWMOD_NO_IDLEST | HWMOD_NO_OCP_AUTOIDLE | HWMOD_INIT_NO_RESET,
	.main_clk	= "sgx_fck",
	.vdd_name       = "core",
...
static struct omap_hwmod omap3xxx_dss_hwmod = {
	...
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAP3430),
	.flags          = HWMOD_INIT_NO_RESET,//Added by huangjieng, dont need init dss in bootup
};
