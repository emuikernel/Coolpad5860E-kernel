...
//Modified by huangjiefeng.2012-01-04
static struct twl4030_resconfig twl4030_rconfig[] = {
	{ .resource = RES_VAUX1,    .devgroup = DEV_GRP_NULL,   .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
    { .resource = RES_VAUX2,    .devgroup = DEV_GRP_ALL,  .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
    { .resource = RES_VAUX3,    .devgroup = DEV_GRP_NULL,   .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
	{ .resource = RES_VAUX4,    .devgroup = DEV_GRP_NULL,   .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },	
	{ .resource = RES_VMMC1,    .devgroup = DEV_GRP_NULL,   .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
    { .resource = RES_VMMC2,    .devgroup = DEV_GRP_ALL,     .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },
	{ .resource = RES_VPLL1,    .devgroup = DEV_GRP_P1,  	.type = 3, .type2 = 1, .remap_sleep = RES_STATE_OFF },
    { .resource = RES_VPLL2,    .devgroup = DEV_GRP_P1,     .type = 0, .type2 = 0, .remap_sleep = RES_STATE_OFF },       
    { .resource = RES_VSIM,     .devgroup = DEV_GRP_ALL,  .type = 0, .type2 = 2, .remap_sleep = RES_STATE_SLEEP },
    { .resource = RES_VDAC,     .devgroup = DEV_GRP_P1,     .type = 0, .type2 = 1, .remap_sleep = RES_STATE_OFF },
	{ .resource = RES_VINTANA1, .devgroup = DEV_GRP_ALL, 	.type = 1, .type2 = 2, .remap_sleep = RES_STATE_SLEEP },
	{ .resource = RES_VINTANA2, .devgroup = DEV_GRP_ALL, 	.type = 0, .type2 = 2, .remap_sleep = RES_STATE_OFF },
	{ .resource = RES_VINTDIG,  .devgroup = DEV_GRP_ALL, 	.type = 1, .type2 = 2, .remap_sleep = RES_STATE_SLEEP },
	{ .resource = RES_VIO,      .devgroup = DEV_GRP_ALL, 	.type = 2, .type2 = 2, .remap_sleep = RES_STATE_SLEEP },
    ...
    //{ .resource = RES_VUSB_1V5, .devgroup = DEV_GRP_NULL,   .type = 0, .type2 =  0, .remap_sleep = RES_STATE_OFF },   
    //{ .resource = RES_VUSB_1V8, .devgroup = DEV_GRP_NULL,   .type = 0, .type2 =  0, .remap_sleep = RES_STATE_OFF },
    //{ .resource = RES_VUSB_3V1, .devgroup = DEV_GRP_NULL,   .type = 0, .type2 =  0, .remap_sleep = RES_STATE_OFF },
	{ .resource = RES_REGEN,    .devgroup = DEV_GRP_ALL, 	.type = 2, .type2 = 1, .remap_sleep = RES_STATE_SLEEP },
	{ .resource = RES_NRES_PWRON, .devgroup = DEV_GRP_ALL,  .type = 0, .type2 = 1, .remap_sleep = RES_STATE_SLEEP },
	{ .resource = RES_CLKEN,    .devgroup = DEV_GRP_ALL, 	.type = 3, .type2 = 2, .remap_sleep = RES_STATE_SLEEP },
	{ .resource = RES_SYSEN,    .devgroup = DEV_GRP_ALL, 	.type = 6, .type2 = 1, .remap_sleep = RES_STATE_SLEEP },
