...
static struct usb_rawbulk_platform_data rawbulk_pdata = {
    ...
    .fn_params[RAWBULK_TID_ETS] = {
        .upstream_transactions = 16,
        .upstream_buffersize = 64,
        .downstream_transactions = 8,
        .downstream_buffersize = 512,
        .downstream_splitcount = 64,
    },
    /* AT channel */
...
#ifdef CONFIG_PM
		// MMS: Remove this line, because it causes issues in camera when
		// removing usb cable for first time after reboot!
