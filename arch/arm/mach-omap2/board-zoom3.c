...
//#else
static struct ohci_hcd_omap_platform_data ohci_omap3_port = {
...
static int gpios[] = {27, -1, -1};//modify for cp5860e,huangjiefeng
...
static void __init omap_zoom_init(void)
{
	...
	omap_mux_init_gpio(27, OMAP_PIN_OUTPUT);//modify for cp5860e,huangjiefeng
	//omap_mux_init_gpio(161, OMAP_PIN_OUTPUT);
	//omap_mux_init_gpio(McBSP3_BT_GPIO, OMAP_PIN_OUTPUT);
	/*config bluetooth pcm pin as input TRISTATE(safe),yanghaishan*/
...
MACHINE_START(OMAP_ZOOM3, "Coolpad5860E")
	.phys_io	= 0x48000000,
